...
const HeadearUserDropDownMenu = () => {
  return (
    <div className=" bg-black bg-opacity-75 border-black h-auto w-52 text-white text-sm font-semibold">
            ...
            <div className="flex flex-row">
              <span className="pr-2">
                <img className="rounded"
                  src="https://occ-0-1492-3663.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABYh1GXyzHI-IqH5gUm3DHnqwmPCTLO5rmui76NzrDHgzMA7or4fZQUjLBsrXzx0JiwagUlQSf7Wiu4yI-A4hfpwleGn8R3g.png?r=54d"
                  alt=""
                />
      ...
      <div className="p-2 border-t-[1px] border-white m-auto text-center cursor-pointer">
        Sign Out Netflix
      </div>
    </div>
  );
...
export default HeadearUserDropDownMenu;
